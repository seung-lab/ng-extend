        ...
        [
          {
            ...
            text:
                `1. Neuroscience needs your help to trace all the wiring of a brain! The brain is composed of neurons, branched cells that pass electrical and chemical signals to each other. Mapping neuronal circuits can help us understand how the brain works. `,
            position: MIDDLE,
            state: 'https://globalv1.flywire-daf.com/nglstate/5531631460810752'
          },
          {
            html:
                `<img style="height: 300px" src="images/tutorial/02 Human Brain.png">`,
            text:
          ...
          {
            html:
                `<img style="height: 300px" src="images/tutorial/03 Fly Brain.png">`,
            text:
          ...
          {
            html:
                `<img style="height: 300px" src="images/tutorial/04 Slicing and Imaging.png">`,
            text:
          ...
          {
            html:
                `<img style="height: 300px" src="images/tutorial/05 Stacked Slices with Moving Neurons.png">`,
            text:
          ...
          {
            html:
                `<img style="height: 300px" src="images/tutorial/06 Circuits.png">`,
            text:
                `6. … with circuits that let the fly see, smell, hear, taste, feel pain, develop addictions, make decisions, remember things, and even try to impress the opposite sex with dance moves. Mapping the whole fly brain would be a big milestone in science, that could teach us fundamental principles about how our own brains work.`,
            position: MIDDLE,
            state: 'https://globalv1.flywire-daf.com/nglstate/5531631460810752'
          },
          {
            html:
                `<img style="height: 300px" src="images/tutorial/07 Crowdsourcing.png">`,
            text:
                `7. But we need your help to crowdsource this effort! FlyWire brings together gamers, scientists and powerful artificial intelligence to try to find neurons in a whole fly brain.`,
            position: MIDDLE,
            state: 'https://globalv1.flywire-daf.com/nglstate/5531631460810752'
          },
          {
            text:
                `8. Here’s the dataset we’ll use, a fly brain cut into about 7000 slices [list credits]. You’re looking at slice #4000, viewed from the front of the fly.`,
          ...
          {
            html:
                `<img style="height: 300px" src="images/tutorial/09 Brain Silhouette.png">`,
            text:
          ...
          {
            html:
                `<img style="height: 300px" src="images/tutorial/13 mitochondria screenshot.png">`,
            text:
                `13. ... and mitochondria (which produce energy for the cell).`,
            position: OVER_3D,
          },

          {
            text:
                `14. Take a look around! CLICK + DRAG to pan [Chris:Do we need to consider moving the pop-up too? Could maybe even lock features at certain points, like prevent scrolling while first learning to zoom, etc.], or RIGHT CLICK to jump to any location.`,
            position: OVER_3D,
          },
          {
            text:
                `15. ou don’t need to memorize these commands. Come back to this tab afterwards, but just click here to open the left menu, then select “Cheatsheet” to open a list of basic commands in a separate tab.`,
            position: {element: `.toggleSidebarButton`, side: `right`},
          },
          {
            text:
                `16. In the Seung lab at Princeton University, we used artificial intelligence (AI) on all the images from this fly brain to try to find all outer cell membranes and fill in possible cells. This process is called “segmentation” since it produces segments of cells.`,
            position: OVER_3D,
          },
          {
            text:
                `17. This 2D slice shows cross-sections of example cells in color. Neurons are 3D objects branched like trees, that can span thousands of slices. In this slice, the pink neuron happened to have a branch sliced lengthwise, the thicker green one was sliced across, and the blue one had branches diving in and out of the slice, appearing in three places here.`,
            position: OVER_3D,
