...
export function isNextToElementPostition(position: NextToElementPostition | InsideElementPostition): position is NextToElementPostition {
...
export const steps: Step[] = [
  ...
  {
    text: "Welcome to the Sandbox! This is a place to play and get acquainted with fly neurons. Have fun learning and exploring. No real data will be harmed!",
    position: MIDDLE,
  },
    {
    text: " If you get stuck, you can click here to return to the default Sandbox view.",
    position: {
      element: '.resetDataset',
      side: 'bottom'
    }
  },
  {
    text: "The 2D view shows one slice of a whole sliced fly brain. Two neurons have been preselected, with their cross sections highlighted in color.",
    position: OVER_2D,
  },
  {
    text: "The 3D view shows the same preselected neurons. Here you can see the 2D cross-section intersecting with the 3D model.",
    position: OVER_3D,
  },
  {
    text: "You can toggle the 2D plane on and off here for easier navigation. Try it!",
    position: {
  ...
  {
    video: 'https://storage.googleapis.com/flywire-frontend/videos/center-3d.mp4',
    position: OVER_3D,
  },
  {
    video: 'https://storage.googleapis.com/flywire-frontend/videos/center-2d.mp4',
    position: OVER_2D,
  },
  {
  ...
  {
    video: 'https://storage.googleapis.com/flywire-frontend/videos/add-remove.mp4',
    position: OVER_2D,
  },
  {
  ...
  {
    html: "Join the <b>Slack Forum</b> to interact with the FlyWire community! You can learn tips and tricks, give suggestions, and meet other FlyWire enthusiasts!",
    position: {
  ...
  {
    html: "You finished the tutorial! You can restart the tutorial at any time.",
    position: {
