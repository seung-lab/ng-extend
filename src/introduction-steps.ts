...
export const steps: Step[] = [
  ...
  {
    html: `<img src="images/tutorial/02 Human Brain.png">`,
    text:
  ...
  {
    html: `<img src="images/tutorial/03 Fly Brain.png">`,
    text:
  ...
  {
    text: `[Pop-up with arrow towards 3D view:] SHIFT + CLICK & DRAG to pan`,
    position: OVER_3D,
  },
  {
    position: OVER_3D,
