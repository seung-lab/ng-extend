        ...
        <div class="nge-leaderboard">
            ...
            <div class="nge-leaderboard-content">
                <div class="nge-leaderboard-timeselect">
                    ...
                    <button v-for="timespan of getTimespanNames()" :key="timespan"
                        :class="'nge-sidebar-button ' + timespan"
                        :title="'Switch to ' + timespan.toLowerCase() + ' leaderboard'"
                        @click="selectButton(timespan)">{{ timespan }}</button>
                    <div class="nge-leaderboard-timeselect-filler"></div>
                </div>
                ...
                <div class="nge-leaderboard-loading" v-show="leaderboardLoaded && leaderboardEntries.length === 0">No
                    edits yet... why not make one?</div>
            </div>
        </div>
    </hologram-panel>
</template>
