        ...
        <div class="content nge-user-profile-content">
            ...
            <div class="nge-user-profile-grid">
                ...
                <div class="nge-user-profile-subgrid">
                    ...
                    <div class="nge-user-profile-count">{{ userInfo.editsToday }} ({{ userInfo.mergesToday }} |
                        {{ userInfo.splitsToday }})</div>
                    <div class="nge-user-profile-count">{{ userInfo.editsThisWeek }} ({{ userInfo.mergesThisWeek }} |
                        {{ userInfo.splitsThisWeek }})</div>
                    <div class="nge-user-profile-count">{{ userInfo.editsAllTime }} ({{ userInfo.mergesAllTime }} |
                        {{ userInfo.splitsAllTime }})</div>
                </div>
                <div class="nge-user-profile-subgrid">
                    <div class="nge-user-profile-timespan">Today</div>
                    <div class="nge-user-profile-timespan">Past 7 Days</div>
