<template>
  <div class="introduction" v-if="appState.finishedLoading && layerState.activeSegmentationLayer && (layerState.activeSegmentationLayer.name === 'Sandbox' || layerState.activeSegmentationLayer.name.startsWith('Public Release'))">
